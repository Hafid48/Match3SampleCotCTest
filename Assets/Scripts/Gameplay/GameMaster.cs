...
namespace Match3Sample.Gameplay
{
    public class GameMaster : MonoBehaviour
    {
        ...
        public IEnumerator OnRoundEnded()
        {
            ...
            print("Round Ended");
            totalScore += PlayerController.PlayerStats.AttackPoints + PlayerController.PlayerStats.DefencePoints;
        ...
        {
            GameSession.Instance.Gamer.Scores.Post(totalScore, "LeaderboardTest", ScoreOrder.HighToLow, null)
            .Then(postedScore => SceneManager.LoadScene("MainMenu"))
            .Catch(ex =>
            {
                // The exception should always be CotcException
                CotcException error = (CotcException)ex;
                Debug.LogError("Failed to post player score: " + error.ErrorCode + " (" + error.HttpStatusCode + ")");
            });
